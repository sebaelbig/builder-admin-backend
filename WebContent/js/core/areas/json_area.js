function JSON_Area(json_e, fila_e){
	...
	this.cargarDatos = function(){
		...
		document.getElementById('combo_sucursales').value = this.json.idSucursal;
	...
	this.tomarDatos = function(){
		...
		this.json.idSucursal = document.getElementById('combo_sucursales').value;
	...
	this.parsearHTML = function(){
		...
		var texto4 = document.createTextNode(this.json.sucursal.nombre); 
