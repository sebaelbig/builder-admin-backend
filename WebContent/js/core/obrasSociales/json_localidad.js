function JSON_Localidad(json_l, fila_e){
	...
	this.cargarDatos = function(){
			...
			document.getElementById('codigoPostal').value = this.json.codigoPostal;
			document.getElementById('provincia').value = this.json.provincia;
	}
	...
	this.tomarDatos = function(){
	   ...
	   this.json.codigoPostal = document.getElementById('codigoPostal').value ;
	   this.json.provincia	= document.getElementById('provincia').value;
	}
	...
	this.parsearHTML = function(){
		...
		var texto3 = document.createTextNode(this.json.codigoPostal); 
		td3.appendChild(texto3);
		
		tr.appendChild(td3);	
		
		var td4 = document.createElement("td");
		var texto4 = document.createTextNode(this.json.provincia); 
