function JSON_DiaAusente(json, pos){
	...
	this.cargarDatos = function(dia){
		...
		if (puedeModificar && puedeEliminar){
			...
			generarBurbujaForm(div,pos,null,"modificarElemento("+this.pos+");",null);
	...
	this.tomarDatos = function(){
		this.json.descripcion = document.getElementById('ausente_edit').value;  
	}
