function JSON_ContratoProfesional(json_p, fila_p){
	...
	this.getLabel = function(){
		return "Contrato en : "+this.json.sucursal.nombre + " del "+ this.json.fechaDesde + " al " + this.json.fechaHasta + ", ejerciendo: "+ this.json.especialidad.nombre +" (Cat. "+ this.json.categoria +")";
	}
