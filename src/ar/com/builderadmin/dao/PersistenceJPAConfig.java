...
//	private Environment env;
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] { "ar.com.builderadmin.model" });
...
//		eclipseLinkProperties.setProperty("eclipselink.session.customizer", "ar.com.builderadmin.dao.StorageSchemaSessionCustomizer");
