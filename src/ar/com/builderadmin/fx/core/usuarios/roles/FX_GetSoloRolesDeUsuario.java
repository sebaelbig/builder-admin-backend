...
public class FX_GetSoloRolesDeUsuario implements I_FX {

	/**
	 * Logger.
	 */
	private final Logger logger = LoggerFactory
			.getLogger(FX_GetSoloRolesDeUsuario.class);
	...
	public FX_GetSoloRolesDeUsuario(DAO dao, String usr, String usuario) {
		setDao((DAO_Rol) dao);
		setUsuarioLDAP(usr);
		setUsuario(usuario);
	...
	public JSON_Respuesta ejecutar(Admin_Alertas adminAlerta) {
		...
		List<Rol_VO> roles = getDao().getRolesDeUsuario( getUsuarioLDAP(), 1);
