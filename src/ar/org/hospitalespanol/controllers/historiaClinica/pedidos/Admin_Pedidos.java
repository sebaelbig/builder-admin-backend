package ar.org.hospitalespanol.controllers.historiaClinica.pedidos;
...
import ar.org.hospitalespanol.dao.historiaClinica.pedidos.DAO_Pedido.R_GetMensajes;
import ar.org.hospitalespanol.dao.historiaClinica.pedidos.estudios.DAO_EstudioDePedido;
import ar.org.hospitalespanol.fx.I_FX;
import ar.org.hospitalespanol.fx.historiaClinica.pedidos.FX_AtenderPedido;
import ar.org.hospitalespanol.fx.historiaClinica.pedidos.FX_BuscarPedido;
import ar.org.hospitalespanol.fx.historiaClinica.pedidos.FX_CancelarPedido;
import ar.org.hospitalespanol.fx.historiaClinica.pedidos.FX_ConfirmarPedido;
import ar.org.hospitalespanol.fx.historiaClinica.pedidos.FX_CrearPedido;
import ar.org.hospitalespanol.fx.historiaClinica.pedidos.FX_InformarPedido;
import ar.org.hospitalespanol.fx.historiaClinica.pedidos.FX_ReabrirPedido;
import ar.org.hospitalespanol.fx.historiaClinica.pedidos.estudios.ItemLista;
...
import ar.org.hospitalespanol.utils.HTTP_Service;
...
import ar.org.hospitalespanol.vo.core.usuarios.Mensaje_VO;
...
import ar.org.hospitalespanol.websocket.historiaClinica.pedidos.WebSocketPedidosServlet;
import ar.org.hospitalespanol.ws.RespuestaCorta;
import ar.org.hospitalespanol.ws.historiaClinica.pedidos.R_RespuestaCharrua;
...
//		Creo el PDF
	...
	public String findByIdBloqueante(Long idPedido, String usuarioAccion)  {
		...
		return (ok)?
					...
					this.getGson().toJson(new RespuestaCorta(ok, "Error de concurrencia"));
	}
