...
import ar.org.hospitalespanol.dao.core.usuarios.roles.DAO_RolHE.R_GetRol;
import ar.org.hospitalespanol.fx.I_FX;
import ar.org.hospitalespanol.vo.core.usuarios.perfiles.Perfil_VO;
import ar.org.hospitalespanol.vo.core.usuarios.roles.RolHE_VO;

public class FX_BuscarRolesHE implements I_FX {
	@Override
	...
	private final Logger logger = LoggerFactory
			.getLogger(FX_BuscarRolesHE.class);
	...
	public FX_BuscarRolesHE(DAO dao, RolHE_VO rol, String usuario) {
	...
	public JSON_Respuesta ejecutar(Admin_Alertas adminAlerta) {
		...
		if (validar()) {
			...
			try {
				...
				R_GetRol roles = getDao().getRoles(getRol());
				...
				pag.setCantPorPagina(roles.getRoles().size());
